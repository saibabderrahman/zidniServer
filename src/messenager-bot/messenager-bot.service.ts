...
@Injectable()
export class MessenagerBotService {
...
💥 بعد صلاة العشاء`,
    ...
    '4':      `يمكنك التسجيل عبر تلغرام من خلال الرابط التالي: https://t.me/Program23bot أو للتسجيل قم بنسخ الرسالة التالية و ملأ معلوماتك عليها  : 
    الإسم : 
    اللقب : 
    العمر : 
    المستوى الدراسي : 
  ...
  private async callSendAPI(senderPsid: string, response: any): Promise<void> {
    const PAGE_ACCESS_TOKEN = this.configService.get<string>('PAGE_ACCESS_TOKEN_TEST');
